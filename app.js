...
const popularResults = document.getElementById('results');
  ...
  data.results.forEach((item) => { 
    ...
    <div class="card">
      ...
      <div class="card-info--container">
        ...
        <span class="badge badge-primary">${item.popularity}</span>
        <span class="badge badge-success">${item.vote_count}</span>
      </div>
  </div>
    `
  }); 
